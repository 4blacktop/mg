...
// <h1>Киноафиша на сегодня</h1><ul class="list"> <div id="footMenu">
// $arrayCinemaURLs = getCatURLs('http://www.moigorod.ru/m/kino/', '#\<\/h1\>\<ul.class\=\"list\"\>(.*)\<div.id\=\"footMenu\"\>#sim', $mtime);

$arrayCinemaURLs = getCatURLs('http://www.moigorod.ru/m/kino/', '#list\"\>(.*)\<div.id\=\"footMenu\"\>#sim', $mtime);
$arrayCinemaURLs = getCatURLs('http://www.moigorod.ru/m/kino/', '#list\"\>(.*)\<div.id\=\"footMenu\"\>#sim', $mtime);
